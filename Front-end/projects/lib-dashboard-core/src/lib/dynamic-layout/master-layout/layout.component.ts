import {
  ...
  AfterViewInit,
  Compiler, NgModuleFactory, Injector
} from '@angular/core';

import { tap } from 'rxjs/operators';

import { LayoutContent } from '../models/LayoutContent';
import { LayoutOutletDirective } from '../layout-outlet.directive';
import { Item } from '../models/item';
import { DashboardService } from '../dynamic-layout.service';
import { IMappedModules, DynamicModuleType } from '../../mapped-modules.interface';
import { DYNAMIC_MODULES_MAP } from '../../dynamic-modules.map';
