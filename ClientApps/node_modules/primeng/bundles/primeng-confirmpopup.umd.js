(function (global, factory) {
    ...
    var ConfirmPopup = /** @class */ (function () {
        ...
        ConfirmPopup.prototype.align = function () {
            ...
            if (dom.DomHandler.getOffset(this.container).top < dom.DomHandler.getOffset(this.confirmation.target).top) {
                dom.DomHandler.addClass(this.container, 'p-confirm-popup-flipped');
            }
            if (Math.floor(dom.DomHandler.getOffset(this.container).left) < Math.floor(dom.DomHandler.getOffset(this.confirmation.target).left) &&
                dom.DomHandler.getOffset(this.container).left > 0) {
                dom.DomHandler.addClass(this.container, 'p-confirm-popup-shifted');
            }
        };
