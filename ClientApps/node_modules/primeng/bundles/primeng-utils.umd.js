(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var FilterUtils = /** @class */ (function () {
        ...
        FilterUtils.notContains = function (value, filter, filterLocale) {
            if (filter === undefined || filter === null || (typeof filter === 'string' && filter.trim() === '')) {
                return true;
            }
            if (value === undefined || value === null) {
        ...
        FilterUtils.between = function (value, filter) {
        ...
        FilterUtils.is = function (value, filter, filterLocale) {
            return FilterUtils.equals(value, filter, filterLocale);
        };
        FilterUtils.isNot = function (value, filter, filterLocale) {
            return FilterUtils.notEquals(value, filter, filterLocale);
        };
        FilterUtils.before = function (value, filter, filterLocale) {
            return FilterUtils.lt(value, filter, filterLocale);
        };
        FilterUtils.after = function (value, filter, filterLocale) {
