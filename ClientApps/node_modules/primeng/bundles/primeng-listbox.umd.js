    ...
    var Listbox = /** @class */ (function () {
        ...
        Listbox.prototype.filterOptions = function () {
            ...
            if (this.hasFilter() && this._options)
                this._filteredOptions = this._options.filter(function (option) { return utils.FilterUtils[_this.filterMatchMode](_this.getOptionLabel(option), _this._filterValue, _this.filterLocale); });
            else
